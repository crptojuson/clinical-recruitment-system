          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <div className="text-center">
                <Stethoscope className="w-8 h-8 text-blue-600 mx-auto mb-2 group-hover:scale-110 transition-transform" />
                <p className="text-sm font-medium text-blue-900">管理试验</p>
              </div>
            </Link>
            ...
            >
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-green-900">审核申请</p>
              </div>
            </Link>
            ...
            >
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-purple-900">编辑博客</p>
              </div>
            </Link>
            ...
            >
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-orange-900">横幅管理</p>
              </div>
            </Link>
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <p className="text-sm font-medium text-gray-900">系统运行正常</p>
          ...
          <div className="text-center">
            ...
            <p className="text-sm font-medium text-gray-900">性能良好</p>
          ...
          <div className="text-center">
            ...
            <p className="text-sm font-medium text-gray-900">用户活跃</p>
